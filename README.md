...
<!-- A benefit is that you don't have to reload when navigating the site. everything is rendered at once and it makes for a snappier and smoother experience for the user. A downside is that people with slower internet connections have to wait for a SPA to load much longer and it could suck for them. -->
